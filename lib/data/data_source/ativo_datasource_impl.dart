...
import 'package:variacao_ativo/data/model/ativo_model.dart';
import 'package:variacao_ativo/domain/entitie/ativo_entity.dart';
import 'package:variacao_ativo/domain/service/http_service.dart';
...
class AtivoDataSourceImpl extends AtivoDataSource {
  ...
  @override
  Future<AtivoEntity> getAtivos() async {
    try {
